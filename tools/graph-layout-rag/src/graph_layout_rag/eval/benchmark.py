...
from graph_layout_rag.eval.gold_validation import EVAL_TRACKS, EvalTrack, cases_for_track, validate_gold
from graph_layout_rag.eval.hardware import (
    assert_memory_start_safe,
    memory_abort_reason,
    memory_snapshot,
    process_rss_gb,
)
from graph_layout_rag.eval.metrics import (
    aggregate_metrics,
    case_metrics,
    crowding_and_duplicates,
    per_category_metrics,
)
from graph_layout_rag.eval.strategies import ALL_STRATEGIES, resolve_strategies
...
def benchmark_cmd(
    ...
    if allow_cloud_cost:
        os.environ["GRAPH_RAG_ALLOW_CLOUD_COST"] = "true"
    ...
    if report:
        from graph_layout_rag.eval.report import write_markdown_report
