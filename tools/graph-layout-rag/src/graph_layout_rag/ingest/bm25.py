"""Tantivy BM25 lexical index for graph-layout-rag, paired with the dense LanceDB index.
...
fusion lives in :mod:`graph_layout_rag.query.hybrid`. Rows mirror the LanceDB row shape
