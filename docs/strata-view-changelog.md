...
| --- | --- | --- | --- | --- |
| 2026-07-12 | `PENDING_W9` | Post-A7 obstacle-avoiding edge routing (penetrating-only polyline detours, cap-6 waypoints, straight-chord fallback; routed arrows exempt from the edge-binding chord flattening). W9: routed edges exact-0 penetrations (scene best −72%) BUT crossings 2.4–3.4× and rt̂ p50+p90 regress on every arm — adverse trade, owner adjudication on direction. | `strataEdgeRouting` / **off** | SDEC-61; [`strata-view-w9-routing-spike.md`](./strata-view-w9-routing-spike.md) |
