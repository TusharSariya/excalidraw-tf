/**
 * Per-option help text for the Terraform import settings panels.
 *
 * The RCLL/Pipeline settings COMPONENT that used to live here was removed with the
 * Pipeline and RCLL views. Only the shared `OPTION_HELP` dictionary (and its
 * `OptionHelpKey` type) survive — the Strata settings components import them.
 */
